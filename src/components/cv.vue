        ...
        <div class="resume-header">
          <div class="row align-items-center">
            <div class="resume-title col-12 col-md-6 col-lg-8 col-xl-9">
              <h2 class="resume-name mb-0">{{data.user.name}}</h2>
              ...
              <ul class="list-unstyled mb-0">
                <li class="mb-2">
                  ...
                  >
                    ...
                    ></path></svg
                  ><!-- <i class="fas fa-phone-square fa-fw fa-lg me-2 "></i> Font Awesome fontawesome.com --><a
                    class="resume-link"
                    :href="'tel:' + data.user.tel"
                    >{{data.user.tel}}</a
                  >
                </li>
                <li class="mb-2">
                  <svg
                    class="
                      svg-inline--fa
                      fa-envelope-square fa-w-14 fa-fw fa-lg
                      me-2
                    "
                    aria-hidden="true"
                    focusable="false"
                  ...
                  >
                    ...
                    ></path></svg
                  ><!-- <i class="fas fa-envelope-square fa-fw fa-lg me-2"></i> Font Awesome fontawesome.com --><a
                    class="resume-link"
                ...
                <li class="mb-2">
                  <svg
                    class="svg-inline--fa fa-globe fa-w-16 fa-fw fa-lg me-2"
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                    data-icon="globe"
                  ...
                  >
                    ...
                    ></path></svg
                  ><!-- <i class="fas fa-globe fa-fw fa-lg me-2"></i> Font Awesome fontawesome.com --><a
                    class="resume-link"
                    target="_blank"
                ...
                <li class="mb-0">
                  <svg
                    class="
                      svg-inline--fa
                      fa-map-marker-alt fa-w-12 fa-fw fa-lg
                      me-2
                    "
                    aria-hidden="true"
                    focusable="false"
                  ...
                  >
                    ...
                    ></path></svg
                  ><!-- <i class="fas fa-map-marker-alt fa-fw fa-lg me-2"></i> Font Awesome fontawesome.com -->
                    {{data.user.location}}
                </li>
              </ul>
            </div>
          ...
          <div class="row">
            <div class="resume-main col-12 col-lg-8 col-xl-9 pe-0 pe-lg-5">
              <section class="work-section py-3">
                ...
                <div class="item mb-4" v-for="item in data.workExperiences" :key="item">
              ...
              <section class="project-section py-3">
                ...
                <div class="item mb-3" v-for="item in data.projects" :key="item">
                  <div class="item-heading row align-items-center mb-2">
                    <h4
            ...
            >
              <section class="skills-section py-3">
                ...
                <div class="item">
                  ...
                  <ul class="list-unstyled resume-skills-list">
                    <li class="mb-2" v-for="item in data.skills.technical" :key="item">{{item}}</li>
                  </ul>
                </div>
                <!--//item-->
                <div class="item">
                  ...
                  <ul class="list-unstyled resume-skills-list">
                    <li class="mb-2" v-for="item in data.skills.professional" :key="item">{{item}}</li>
                  </ul>
                </div>
                <!--//item-->
              </section>
              ...
              <section class="education-section py-3">
                ...
                <ul class="list-unstyled resume-education-list">
                  <li class="mb-3" v-for="item in data.education" :key="item">
                    ...
                    <div class="resume-degree-time text-muted">{{item.startDate}} - {{item.endDate}}</div>
                  </li>
                </ul>
              </section>
              <!--//education-section-->
              <section class="education-section py-3">
                ...
                <ul class="list-unstyled resume-awards-list">
                  <li class="mb-3" v-for="item in data.awards" :key="item">
                    <div class="font-weight-bold">{{item.name}}</div>
                    <div class="text-muted">{{item.organisation}} ({{item.year}})</div>
                  </li>
                </ul>
              </section>
              <!--//education-section-->
              <section class="skills-section py-3">
                ...
                <ul class="list-unstyled resume-lang-list">
                  <li class="mb-2" v-for="item in data.languages" :key="item">
                    {{item.language}} <span class="text-muted">({{item.level}})</span>
                  </li>
                </ul>
              </section>
              ...
              <section class="skills-section py-3">
                ...
                <ul class="list-unstyled resume-interests-list mb-0">
                  <li class="mb-2" v-for="item in data.interests" :key="item">{{item}}</li>
                </ul>
              </section>
              <!--//certificates-section-->
            </aside>
            ...
            <li class="list-inline-item mb-lg-0 me-3">
              <a class="resume-link" href="#"
                ><svg
                  ...
                  viewBox="0 0 448 512"
                  data-fa-i2svg=""
                  style="transform-origin: 0.4375em 0.75em"
                >
